...
class Customer:
    ...
    def searchId(self):
        try:
            ...
            raise Exception(ex,"Error while searching")
    ...
    def connection(user, password):
        try:
            global con
            con = pymysql.connect(host="localhost", user=user, password=password, database="cms")
        except Exception as ex:
            print(ex)
...
if(__name__=="__main__"):
    ...
    while(True):
        try:
            ...
            Customer.connection(password, database)
